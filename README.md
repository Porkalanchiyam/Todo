...
```
cd existing_repo
git remote add origin https://gitlab.com/crayond-upskill/task-1/porkalanchiyam.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/crayond-upskill/task-1/porkalanchiyam/-/settings/integrations)
